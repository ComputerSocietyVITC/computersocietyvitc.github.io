      ...
      (<div>
        ...
        <div className="h-5/6">
          <div className="font-sans text-right mx-4 lg:mx-40 mt-52 text-5xl lg:text-7xl font-black text-white">
            ...
            <h1 className="font-montserrat font-normal text-2xl lg:text-3xl text-white my-16 lg:my-24 lg:ml-36 lg:leading-custom">
        ...
        <div className="h-4/6">
          <div className="font-sans text-left mx-4 lg:mx-40 pt-8 text-5xl lg:text-7xl font-black text-white">
            ...
            <h1 className="font-montserrat font-normal text-2xl lg:text-3xl text-white my-16 lg:my-24 lg:mr-36 lg:leading-custom">
        ...
        <div className="h-5/6">
          <div className="font-sans text-center mx-4 lg:mx-40 pt-6 lg:pt-10 text-5xl lg:text-7xl font-black text-white">
            ...
            <div className="text-xl flex justify-center">
              <p className="font-montserrat font-normal text-2xl lg:text-3xl text-white ml-auto mr-auto mt-12 px-2 lg:px-72 text-center lg:leading-custom">
