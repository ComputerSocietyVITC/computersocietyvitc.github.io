        ...
        <div>
          ...
          <div>
            <div
              ...
              className={
                "bottom-10 right-12 hidden fixed z-20" +
                (visible === "goTop" ? " md:block" : " hidden")
              }
            >
              <svg
          ...
          <div className="h-5/6">
            <div
              className="font-catamaran text-left mx-4 lg:mx-28 mt-20 text-black relative"
              id="outlinetext"
            >
          ...
          <div className="h-5/6">
            <div className="font-sans text-right mx-4 lg:mx-40 mt-52 text-5xl lg:text-7xl font-black text-white">
              ...
              <h1 className="font-montserrat font-normal md:font-bold text-2xl lg:text-3xl text-white my-16 lg:my-24 lg:ml-36 lg:leading-custom">
                IEEE Computer Society VIT Chennai is a zealous community of
                diverse minds striving to Learn, Create (sometimes Break!),
                Develop, and Explore. Here we combine an infectious desire to
                grow together, and a stubborn persistence to keep going, with a
                healthy ambition for the next audacious challenge. Come join us
                on this journey!
              </h1>
            </div>
          </div>
          <div className="h-4/6">
            <div className="font-sans text-left mx-4 lg:mx-40 pt-8 text-5xl lg:text-7xl font-black text-white">
              ...
              <h1 className="font-montserrat font-normal md:font-bold text-2xl lg:text-3xl text-white my-16 lg:my-24 lg:mr-36 lg:leading-custom">
                At IEEE Computer Society VITC, our belief is grounded in the
                principles of mutual learning and growth. We believe in
                empowering the community to innovate, develop, create, and to
                empower itself, which for us is, the greatest Return on
                Investment for a Technical Society.
                <br />
                <br />
                With a transcendent passion for Tech, and a solemn cognizance of
                people's struggles, we aspire to solve the great problems of
                today, and prepare together for a brighter tomorrow.
              </h1>
            </div>
          </div>
          <div className="h-5/6">
            <div className="font-sans text-center mx-4 lg:mx-40 pt-6 lg:pt-10 text-5xl lg:text-7xl font-black text-white">
              ...
              <div className="text-xl flex justify-center">
                <p className="font-montserrat font-normal md:font-bold text-2xl lg:text-3xl text-white ml-auto mr-auto mt-12 px-2 lg:px-72 text-center lg:leading-custom">
                  Want to stay updated with the latest news about IEEE CS VITC?
                  Enter you email address and allow notifications.
                </p>
              </div>
              <form onSubmit={submitEmail} id="newsletterform">
                ...
                <div
                  className="bg-gradient-to-r from-color1 to-color2 px-12 py-4 ml-auto mr-auto mt-12 md:mt-16 text-2xl lg:text-4xl text-white w-3/5 lg:w-1/4 shadow-xl hover:shadow-md hover:from-comsocgreen"
