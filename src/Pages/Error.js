...
const Error = () => {
  ...
  return (
    <div className="mb-20 -mt-5">
      ...
      <h1 className="font-sans text-center text-6xl -mt-5 text-comsocgreen lg:-mt-20 lg:text-8xl">
        lost in space
      </h1>
      <h1 className="font-sans text-center text-xl lg:text-3xl mt-4">
        you have reached the edge of universe
      </h1>
