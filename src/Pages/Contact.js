    ...
    <div>
      {loading ? (
        ...
        <div className="relative z-10">
          ...
          <div
            className="font-catamaran text-center mt-10 mb-6 text-black"
            id="outlinetext"
          >
            <h1>CONTACT US</h1>
          </div>
                    ...
                    <div className="sm:rounded-md">
                      <div className="col-span-6">
                        ...
                        <input
                          ...
                          required
                          autoComplete="name"
                          className="bg-gray-900 p-3 border-0 mt-1 focus:ring-comsocgreen focus:border-comsocgreen block w-full shadow-sm sm:text-sm border-gray-300 rounded-md "
                          placeholder="Name"
                        />
                      </div>
                      <br />
                        ...
                        <div>
                          ...
                          <div className="mt-1">
                            <textarea
                              ...
                              rows={3}
                              required
                              className="bg-gray-900  p-3 border-0 shadow-sm focus:ring-comsocgreen focus:border-comsocgreen mt-1 block w-full sm:text-sm rounded-md"
                              placeholder="Message"
                            />
                          </div>
                        </div>
                      ...
                      <div className="text-center">
                        <button
                          type="submit"
                          className="mt-8 bg-gradient-to-r from-color1 to-color2 inline-flex justify-center py-2 px-14 border border-transparent shadow-xl hover:shadow-sm text-lg font-medium mr-auto ml-auto rounded-full text-white hover:from-comsocgreen"
                        >
                          Submit
                        </button>
                      </div>
