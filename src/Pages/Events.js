...
const Events = () => {
  ...
  const images = importAll(
    require.context(
      "../components/carousel/images/events",
      false,
      /\.(png|jpe?g|svg|gif)$/
    )
  );
                    ...
                    <div className="lg:my-6">
                      <div className="grid grid-cols-1 lg:grid-cols-2 lg:mt-12">
                        <div className="ml-auto lg:h-2/3 lg:mt-16">
                          <img
                            src={images[event["image"]].default}
                            alt={event.event}
                            className="w-full h-full"
                          />
                        </div>
                        <div
                          className="overflow-auto text-lg lg:text-2xl font-medium text-justify lg:mr-20 p-3 py-6 lg:p-16 lg:pb-0 bg-bgcolor1"
                          id="carouselcard"
                        >
                          <h1 className="text-4xl lg:text-6xl uppercase font-semibold mb-6 lg:mb-10">
                            {event.event}
                          </h1>
                          <span className="text-xl lg:text-2xl font-medium text-comsocgreen">
                            {event.date}
                          </span>
                          <br />
                          <br />
