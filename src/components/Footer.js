        ...
        <div>
            <footer className="bg-gradient-to-b from-bgcolor3 to-black font-montserrat">
                <div className="pb-6 text-gray-800 flex flex-wrap justify-left text-left">
                    <div className="pt-4 md:w-3/12">
                        <img src={comsocLogowhite} alt="Comsoc Logo" className='px-4 lg:pl-20' />
                        <p className='text-white text-xs pt-12 lg:pl-14 text-center lg:text-right'>©️ Copyright 2022 - IEEE CS VITC. All Rights Reserved.</p>
                    </div>
                    <div className="mt-3 w-full md:w-3/12 py-6 lg:py-0 pl-28">
                        <div className="text-md text-white mr-56 mb-6">
                            Menu
                    ...
                    <div className="mt-3 w-full md:w-3/12 pl-4">
                        <div className="text-md text-white mr-72 mb-6">
                            Address
                            <div id='underlineGradient' className='mr-3' />
                        </div>
                        <a href="https://goo.gl/maps/C9UE9JLWnBAfQPKe7" target="_blank" className="my-3 block text-white hover:text-gray-200 text-sm pr-32">
                        ...
                        <a href="mailto:ieeecomputersociety@vit.ac.in" target="_blank" className="my-3 block text-white hover:text-gray-200 text-sm">
