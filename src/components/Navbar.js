            ...
            <ul className="flex flex-col lg:flex-row list-none lg:ml-auto text-xl pt-5 lg:pt-0 lg:text-lg">
              <li className="nav-item">
                ...
                >
                  ...
                  <span
                    className="ml-2"
                    style={pageSelected.home ? pageSelectedStyle : {}}
                  >
                    Home
                  </span>
                </Link>
              ...
              <li className="nav-item">
                ...
                >
                  ...
                  <span
                    className="ml-2"
                    style={pageSelected.team ? pageSelectedStyle : {}}
                  >
                    The Team
                  </span>
                </Link>
              ...
              <li className="nav-item">
                ...
                >
                  ...
                  <span
                    className="ml-2"
                    style={pageSelected.events ? pageSelectedStyle : {}}
                  >
                    Events
                  </span>
                </Link>
              ...
              <li className="nav-item">
                ...
                >
                  ...
                  <span
                    className="ml-2"
                    style={pageSelected.projects ? pageSelectedStyle : {}}
                  >
                    Projects
                  </span>
                </Link>
              ...
              <li className="nav-item">
                ...
                >
                  ...
                  <span
                    className="ml-2"
                    style={pageSelected.blogs ? pageSelectedStyle : {}}
                  >
                    Blogs
                  </span>
                </Link>
              ...
              <li className="nav-item">
                ...
                >
                  ...
                  <span
                    className="ml-2"
                    style={pageSelected.contact ? pageSelectedStyle : {}}
                  >
                    Contact
                  </span>
                </Link>
